                ...
                <table>
                    ...
                    <form action="./mypage_user_update.php" name="user_form" method="post">
                        ...
                        <tr class="id_password" style="display: none;">
                            <td>새 비밀번호</td>
                            <td colspan="3">
                                <input type="password" name="password" id="password_new" placeholder="새 비밀번호 입력"
                                    required>
                                <div></div>
                            </td>
                        </tr>
                        ...
                        <tr class="email">
                            <td>이메일</td>
                            <td colspan="3">
                                <input type="text" id="email1" name="email1" value="<?= $row['email1'] ?>" readonly
                                    required>
                                <span>@</span>
                                <input type="text" id="email2" name="email2" value="<?= $row['email2'] ?>" readonly
                                    required>
                        ...
                        <tr class="phone">
                            <td>휴대전화</td>
                            <td colspan="3">
                                <input type="text" id="mobile1" name="mobile1" value="<?= $row['mobile1'] ?>" readonly
                                    required>
                                <span>-</span>
                                <input type="text" id="mobile2" name="mobile2" value="<?= $row['mobile2'] ?>" readonly
                                    required>
                                <span>-</span>
                                <input type="text" id="mobile3" name="mobile3" value="<?= $row['mobile3'] ?>" readonly
                                    required>
                                <div></div>
                            </td>
                        </tr>

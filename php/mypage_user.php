        ...
        <!DOCTYPE html>
                    ...
                    <body>
                                    ...
                                    <table>
                                        ...
                                        <form action="./mypage_inquiry_board.php" method="post">
                                            ...
                                            <tr class="email">
                                                <td>이메일</td>
                                                <td colspan="3">
                                                    <input type="text" id="email1" value="<?= $row['email1'] ?>" readonly required>
                                                    <span>@</span>
                                            ...
                                            <tr class="phone">
                                                <td>휴대전화</td>
                                                <td colspan="3">
                                                    <input type="text" id="mobile1" value="<?= $row['mobile1'] ?>" readonly required>
                                                    <span>-</span>
                        ...
                        <script>
                            ...
                            const set_event = function(){

                                // id 중복 및 형식 체크
                                id.addEventListener('keyup', function(){
                                    let str = this.value
                                    let reg_id = /^[a-z0-9_-]{4,20}$/;
                                    if(reg_check(this, str, reg_id, '사용가능한 아이디 입니다', '형식에 맞지 않는 아이디입니다')){
                                        form_flag = formCheck(this, str)
                                    }
                                })
                                ...
                                password_new.addEventListener('keyup', function(){
                                    ...
                                    reg_check(this, str, reg_id, '사용가능한 비밀번호입니다', '최소 8자, 하나의 숫자와 특수 문자 포함한 문자')
                                })
                                ...
                                password_check.addEventListener('keyup', function(){
                                    ...
                                    if(str === ''){
                                        ...
                                        this.nextElementSibling.innerHTML = '<span style="color: blue; font-size: 14px;">비밀번호가 일치합니다</span>'
                                        form_flag = true
                                    }else{
                                ...
                                mobile1.addEventListener('keyup', function(){
                                    ...
                                    reg_check(this, str, reg_mobile1, '사용가능한 번호입니다', '전화번호 형식이 아닙니다')
                                })
            
                                mobile2.addEventListener('keyup', function(){
                                    let str = this.value
                                    let reg_mobile2 =  /^([0-9]{3,4})$/
                                    reg_check(this, str, reg_mobile2, '사용가능한 번호입니다', '전화번호 형식이 아닙니다')
                                })
            
                                mobile3.addEventListener('keyup', function(){
                                    let str = this.value
                                    let reg_mobile3 =  /^([0-9]{3,4})$/
                                    reg_check(this, str, reg_mobile3, '사용가능한 번호입니다', '전화번호 형식이 아닙니다')
                                })
                            }
                            ...
                            let formCheck = function(button, str, mode) {
                                ...
                                xhttp.open("GET", "user_update.php?q=" + str, true)
                                xhttp.send()
                            }

                            function change_attr(flag) {
                                let str = ""
                                if (flag) str = "none"

    ...
    <aside>
      <div>
        <ul>
          ...
          <hr>
          <li><a href="./room_double.php">더 블</a></li>
          <li><a href="./room_twin.php">트 윈</a></li>
          <li class="title"><a href="./room_triple.php">트리플</a></li>
          <li><a href="./room_grand.php">그랜드</a></li>
        </ul>
      </div>
    </aside>

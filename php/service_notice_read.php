...
<head>
    ...
    <link rel="stylesheet" href="../css/service_notice_read.css">
                ...
                <form method="post" action="service_notice_crud.php">
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="currentDate" name="written_date"
                                    value="<?php echo $written_date?>" readonly>
                            </td>
                        </tr>

                        <tr>
                            <td class="title"><b>내 용</b></td>
                            <td><textarea id="content" name="content" cols="30"
                        ...
                        <tr>
                            ...
                            <td><textarea name="content" cols="30" rows="10" readonly><?php echo $content; ?></textarea>
                            </td>
                        </tr>
                        <?php } ?>
                    </table>
